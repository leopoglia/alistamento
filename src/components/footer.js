...
export default function Footer(props) {
    ...
    return (
        <footer className={"flex justify-between fixed bottom-0 text-sm w-full font-light h-10 px-10 " + (props.style == "black" ? "text-black fill-black" : "text-white fill-white")}>
